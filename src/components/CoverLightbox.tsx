...
export default function CoverLightbox({
  ...
  return (
    <div
      className="fixed inset-0 z-[100] overflow-y-auto bg-black/85 p-4 backdrop-blur-md"
    ...
    >
      <button
        ...
        onClick={onClose}
        aria-label="Fermer"
        className="fixed right-4 top-4 z-10 flex h-11 w-11 items-center justify-center rounded-full bg-white/10 text-xl text-white backdrop-blur transition hover:bg-white/20 sm:right-6 sm:top-6"
      >
        ✕
      </button>
      ...
      {books.length > 1 && (
        <>
          <button
            ...
            className="fixed left-2 top-1/2 z-10 flex h-12 w-12 -translate-y-1/2 items-center justify-center rounded-full bg-white/10 text-2xl text-white backdrop-blur transition hover:bg-white/20 sm:left-6"
          >
            ‹
          </button>
          <button
            ...
            className="fixed right-2 top-1/2 z-10 flex h-12 w-12 -translate-y-1/2 items-center justify-center rounded-full bg-white/10 text-2xl text-white backdrop-blur transition hover:bg-white/20 sm:right-6"
          >
            ›
          </button>
        </>
