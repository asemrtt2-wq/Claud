    ...
    <>
      ...
      <section className="px-6 py-24">
        <div className="mx-auto max-w-5xl text-center">
          ...
          <p className="mx-auto mb-16 max-w-xl text-[1.05rem] text-text-muted">
            Achète un eBook à l&apos;unité ou passe à Premium pour un accès illimité à
            toute la bibliothèque.
          </p>

          <div className="grid gap-7 md:grid-cols-3">
            <div className="flex flex-col rounded-[22px] border border-gray-mid bg-white p-8 text-left shadow-soft">
              <span className="mb-2 text-xs font-extrabold uppercase tracking-wider text-text-muted">
                Gratuit
              </span>
              <div className="mb-6 text-4xl font-extrabold text-navy">0 €</div>
              <ul className="mb-8 flex flex-1 flex-col gap-3 text-sm text-text-muted">
            ...
            <div className="flex flex-col rounded-[22px] border-2 border-royal bg-white p-8 text-left shadow-strong">
              ...
              <p className="mb-6 text-sm text-text-muted">par mois</p>
              <ul className="mb-8 flex flex-1 flex-col gap-3 text-sm text-text-muted">
            ...
            <div className="flex flex-col rounded-[22px] border border-gray-mid bg-white p-8 text-left shadow-soft">
              ...
              <div className="mb-1 text-4xl font-extrabold text-navy">79 €</div>
              <p className="mb-6 text-sm text-text-muted">par an</p>
              <ul className="mb-8 flex flex-1 flex-col gap-3 text-sm text-text-muted">
