      ...
      <div className="mx-auto max-w-5xl px-6 py-10">
        <div className="mb-8 grid grid-cols-3 gap-5">
          <div className="rounded-2xl border border-gray-mid bg-white p-5 shadow-soft">
            <p className="text-xs font-bold uppercase tracking-wide text-text-muted">eBooks</p>
            <p className="text-2xl font-extrabold text-navy">{ebooks.length}</p>
          </div>
          <div className="rounded-2xl border border-gray-mid bg-white p-5 shadow-soft">
        ...
        <div className="mb-6 flex items-center justify-between">
          <h1 className="text-2xl font-extrabold tracking-tight text-navy">Catalogue</h1>
          <Link
